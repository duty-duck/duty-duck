<template>
  <BButton v-if="isAllowed" class="icon-link" variant="outline-secondary" @click="handleToggle" :disabled="isToggling">
...
const isAllowed = auth.userHasPermissionComputed('writeHttpMonitors');
