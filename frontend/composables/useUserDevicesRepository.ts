import type { ListUserDevicesResponse } from "bindings/ListUserDevicesResponse";
...
import type { UserDeviceType } from "bindings/UserDeviceType";

export const useThisDeviceType = (): UserDeviceType => {
    let check = false;
    // @ts-ignore
    try {
        ...
        console.log("Error while checking device type:", e);
    } finally {
...
export const useThisDevice = async () => {
    ...
    return computed<UserDevice | null>(() => {
        ...
        const device = devices.find(device =>
            device.pushNotificationToken && device.pushNotificationToken == thisDeviceToken
        );
